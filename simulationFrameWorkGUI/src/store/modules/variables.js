...
const actions = {
  loadAllVariables: function({ commit }, payload) {
    axios
      .request({ url: "/datasource/headers", data: null, params: payload })
      .then(res => {
  ...
  loadCustomVariables: function({ commit }, payload) {
    axios
      .request({ url: "/variables/load", data: null, params: payload })
      .then(res => {
  ...
  setVariablesInBack: function({ commit }, payload) {
    axios
      .put(
        "/variables/setheaders/" + payload.projectName,
        payload.headersSelected
      )
      .then(res => {
